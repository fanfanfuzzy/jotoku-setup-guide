...
| 第3回 | SSHでサーバー接続 | ターミナル基本操作、SSH鍵、VS Code Remote-SSH |
| 第4回 | サーバー上でPythonを動かす | 仮想環境、pip、GPU確認 |
| 第5回 | 実験の実行と管理 | バックグラウンド実行、結果整理、Git管理 |
| 第6回 | Docker入門 | コンテナの概念、Dockerfile作成 |
